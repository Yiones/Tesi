...
% ------------------------------------------------------------------------ %
%
\newcommand{\myName}{Yiones Aouadi}			% autore
\newcommand{\myMatricola}{872727}			% matricola
...
\newcommand{\myDegree}{Engineerig physics}		% laurea
\newcommand{\myThesis}{Tesi di Laurea Magistrale}	% tipo di tesi
\newcommand{\myDepartment}{Dipartimento di Fisica}	% dipartimento
\newcommand{\myProf}{Prof.~Giacomo~Ghiringhelli}		% relatore
\newcommand{\myOtherProf}{Ing.~Emilio~Salgari}		% eventuale correlatore
\newcommand{\myLocation}{Milano}			% dove
\newcommand{\myTime}{Dicembre 2018}			% quando
\newcommand{\myAcademicYear}{2017--2018}		% anno accademico
